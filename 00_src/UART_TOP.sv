...
BAUD_GEN baud_gen(
    .I_CLK(I_CLK),
    .I_RESET_N(I_RESET_N),
    .I_BAUD_RATE(/*I_BAUD_RATE*/ 4'b0),
    .I_BCLK_MODE(/*I_BCLK_MODE*/ 1'b0),
    .I_CNT_EN(/*I_CNT_EN*/ 1'b1),
...
RECEIVER_SHIFT_REG receiver_shift_reg(
    ...
    .I_RX_IN(I_RX_IN),
    .I_PARITY_EN(/*I_PARITY_EN*/ 1'b1),
    .I_PARITY_TYPE(/*I_PARITY_TYPE*/1'b1),
